...
internal static unsafe partial class XxHash3 {
	...
	[MethodImpl(Inline)]
	private static void Accumulate512Neon(ulong* accumulatorStore, byte* data, byte* secret) {
	...
	[MethodImpl(Inline)]
	private static void ScrambleAccumulatorNeon(ulong* accumulatorStore, byte* secret) {
		ref var accumulator = ref *(CombinedVector128X512<ulong>*)accumulatorStore;
