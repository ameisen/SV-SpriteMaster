...
#if !SM_LIBRARY
	[MethodImpl(Runtime.MethodImpl.Inline)]
	internal static int ClampDimension(this int value) => Math.Min(value, SMConfig.ClampDimension);

	[MethodImpl(Runtime.MethodImpl.Inline)]
	internal static Vector2I ClampDimension(this Vector2I value) => value.Min(SMConfig.ClampDimension);
#endif
