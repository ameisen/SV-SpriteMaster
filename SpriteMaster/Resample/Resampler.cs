...
internal sealed partial class Resampler {
	...
	internal static unsafe NewTextureResult CreateNewTextureDirect(
		...
		*/
		...
		bool resamplingAllowed = SMConfig.Resample.IsEnabled || (Configuration.Preview.Override.Instance?.Scaler ?? SMConfig.Resample.Scaler) == Scaler.None;
...

		{
			...
			if (scaledSize != scaledSizeClamped) {
				...
				Debug.Trace($"Sprite requires rescaling");
