...
static partial class ReflectionExt {
	...
	internal static bool TryGetField(this Type type, string name, out FieldInfo field, BindingFlags bindingAttr) {
	...
	[MethodImpl(Runtime.MethodImpl.Hot)]
	[DynamicallyAccessedMembers(AllFields)]
	internal static bool TryGetField(this Type type, string name, out FieldInfo field) => type.TryGetField(name, out field, AllNonFlatBinding);

	[MethodImpl(Runtime.MethodImpl.Hot)]
	[DynamicallyAccessedMembers(AllProperties)]
	internal static bool TryGetProperty(this Type type, string name, out PropertyInfo property, BindingFlags bindingAttr) {
	...
	[MethodImpl(Runtime.MethodImpl.Hot)]
	[DynamicallyAccessedMembers(AllProperties)]
	internal static bool TryGetProperty(this Type type, string name, out PropertyInfo property) => type.TryGetProperty(name, out property, AllNonFlatBinding);

	[MethodImpl(Runtime.MethodImpl.Hot)]
	[DynamicallyAccessedMembers(AllMethods)]
	internal static bool TryGetMethod(this Type type, string name, out MethodInfo method, BindingFlags bindingAttr) {
	...
	[MethodImpl(Runtime.MethodImpl.Hot)]
	[DynamicallyAccessedMembers(AllMethods)]
	internal static bool TryGetMethod(this Type type, string name, out MethodInfo method) => type.TryGetMethod(name, out method, AllNonFlatBinding);
