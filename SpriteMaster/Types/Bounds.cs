...
namespace SpriteMaster.Types
{
		...
		IEquatable<XTileRectangle>
	{
		...
		public Bounds(in int x, in int y, in int width, in int height) : this(new Vector2I(x, y), new Vector2I(width, height)) { }

		public Bounds(in int width, in int height) : this(0, 0, width, height) { }

		public Bounds(in Vector2I extent) : this(Vector2I.Zero, extent) { }
		...
		public readonly bool NotEquals(Bounds other)
		{
			return
				X != other.X ||
				Y != other.Y ||
		...
		public readonly bool NotEquals(DrawingRectangle other)
		{
			return
				X != other.X ||
				Y != other.Y ||
		...
		public readonly bool NotEquals(XNARectangle other)
		{
			return
				X != other.X ||
				Y != other.Y ||
		...
		public readonly bool NotEquals(XTileRectangle other)
		{
			return
				X != other.X ||
				Y != other.Y ||
