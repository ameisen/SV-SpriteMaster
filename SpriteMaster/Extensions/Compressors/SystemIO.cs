...
static class SystemIO {
	...
	internal static byte[] CompressTest(byte[] data) {
		...
		try {
			...
			using (compressor = new IOC.DeflateStream(val, System.IO.Compression.CompressionLevel.Optimal)) {
	...
	internal static byte[] Decompress(byte[] data) {
		...
		using (var compressor = new IOC.DeflateStream(dataStream, System.IO.Compression.CompressionMode.Decompress)) {
