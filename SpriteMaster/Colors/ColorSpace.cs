...
readonly struct ColorSpace {
	...
	internal readonly Fixed16 Linearize(Fixed16 value) => LinearizeTable16[(ushort)value];
	...
	internal readonly Fixed16 Delinearize(Fixed16 value) => DelinearizeTable16[(ushort)value];
